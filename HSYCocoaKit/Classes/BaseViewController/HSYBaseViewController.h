...
@property (nonatomic, assign) BOOL addKeyboardObserver;        //是否添加键盘监听
@property (nonatomic, strong) HSYBaseRefleshModel *viewModel;  //该指针允许指向HSYBaseModel子类中的对象，并且使用了建言模式，不允许为nil，默认为nil，实例化对象请务必在“- viewDidLoad”方法“前”。
